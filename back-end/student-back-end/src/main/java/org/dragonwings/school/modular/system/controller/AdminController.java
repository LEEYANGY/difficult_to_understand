...
//        Page<HealthReport> healthReportPage = healthReportService.page(new Page<HealthReport>(page, limit), new QueryWrapper<HealthReport>().orderByDesc("id"));
        return ResponseData.success(
                200, "获取成功",
                healthReportService.page(new Page<HealthReport>(page, limit), new QueryWrapper<HealthReport>().orderByDesc("id")));
    }
...
//      通知管理
    ...
    public ResponseData getDetail(@PathVariable Long id) {
        return ResponseData.success(200, "获取成功", messageMapper.selectOne(new QueryWrapper<Message>().eq("id", id)));
    }
...
//        分页查询
    ...
    */
    ...
    public ResponseData getUserDetail(@PathVariable Long userId) {
        return ResponseData.success(200, "获取成功", userService.getOne(new QueryWrapper<User>().eq("user_id", userId)));
    }
