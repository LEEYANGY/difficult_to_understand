//package xyz.leeyangy.school.framework.socket;
//
...
// * @Package org.dragonwings.school.framework.socket
// * @Version 1.0
...
//     * 存储用户
//     */
//    public static final Map<Long, LoginUser> userMap = new ConcurrentHashMap<>();
//
//    /**
//     * 连接建立成功调用的方法
//     * 建立连接之后，将所有聊天记录查出来给前端显示
//     */
//    @OnOpen
